...
\title{Problem 2.1.7}
\subtitle{Imaginary free particle}
...
\begin{document}
	\maketitle
	Use the imaginary-time path integral to calculate the propagator of a free particle in imaginary time.
	Perform a proper analytic continuation to recover the real-time propagator.
